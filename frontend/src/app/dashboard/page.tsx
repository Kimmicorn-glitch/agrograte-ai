...
import { ArrowUp, ArrowDown, TrendingUp, AlertTriangle, Zap } from 'lucide-react'
  ...
  const metrics = [
    {
      ...
      subtitle: banking?.accounts?.length ? `${banking.accounts.length} accounts` : 'No linked accounts',
    },
    {
      id: 'tax-exposure',
      label: 'Tax Exposure',
    ...
    },
    {
      ...
      subtitle: compliance?.outstanding_returns ?? 0 ? `${compliance.outstanding_returns} outstanding` : 'All clear',
    },
    {
      ...
      change: 'AI Generated',
      trend: 'up' as const,
      subtitle: 'Based on 90-day history',
    },
  ]
              ...
              <div className="text-center space-y-3 sm:space-y-4">
                ...
                <div className="space-y-1 sm:space-y-2">
                  <p className="text-body-sm sm:text-body-md text-secondary font-medium">
                    {complianceScore && complianceScore >= 80 ? 'Excellent Financial Health' : complianceScore && complianceScore >= 60 ? 'Good Financial Health' : 'Needs Attention'}
                  </p>
          ...
          <div className="p-4 sm:p-6 lg:p-8 bg-charcoal-50/50">
            <div className="h-48 sm:h-56 lg:h-64 flex items-end justify-between gap-1 bg-gradient-to-t from-accent/5 to-transparent p-3 sm:p-4 rounded-lg">
              {cashflow?.scenarios?.length ? (
                ...
                <div className="flex-1 flex items-center justify-center text-body-sm sm:text-body-md text-charcoal-400">
