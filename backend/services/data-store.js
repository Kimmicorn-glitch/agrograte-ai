...
const INITIAL_DATA = {
  ...
  accounts: {
    'acct-1': {
      ...
      current_balance: 2847530.00,
      available_balance: 2812340.00,
      reserved_tax_funds: 384200.00,
      is_active: true,
      currency: 'ZAR',
  ...
  drrt_state: {
    ...
    trend: 'improving',
    dimensions: [
      { id: 'dim-1', name: 'Cash Flow', weight: 0.25, activation: 0.88 },
      { id: 'dim-2', name: 'Revenue', weight: 0.20, activation: 0.76 },
      { id: 'dim-3', name: 'Expenses', weight: 0.15, activation: 0.82 },
      { id: 'dim-4', name: 'Compliance', weight: 0.20, activation: 0.94 },
      { id: 'dim-5', name: 'Risk', weight: 0.10, activation: 0.15 },
      { id: 'dim-6', name: 'Forecast', weight: 0.10, activation: 0.78 },
    ],
    relationships: [],
    memory: [],
    financial_metrics: {
      total_balance: 2847530.00,
      free_cash: 2453330.00,
      liquidity_ratio: 0.86,
      revenue: 0,
      expenses: 0,
      profit: 0,
      vat_compliance_ratio: 1.0,
      tax_compliance_ratio: 1.0,
...
function getDataStore() {
  if (!instance) {
    ...
    instance.seedSampleTransactions()
    instance.seedSampleInvoices()
  }
  return instance
}
